        ...
        <div className="flex min-h-[calc(100vh-4rem)] flex-col items-center justify-center bg-[#050505] px-4 py-12 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            >
                <div className="text-center mb-8">
                    <div className="flex flex-col items-center gap-3 transition-all duration-500 hover:scale-105">
                        <img
                            src="/studio_logo.svg"
                            alt="StudioX Icon"
                            draggable="false"
                            className="h-16 object-contain filter drop-shadow-[0_0_40px_rgba(168,85,247,0.55)] select-none"
                        />
                        <img
                            src="/studio_brandname.svg"
                            alt="StudioX"
                            draggable="false"
                            className="h-8 object-contain filter drop-shadow-[0_0_30px_rgba(168,85,247,0.4)] select-none"
                        />
                    </div>
                </div>
