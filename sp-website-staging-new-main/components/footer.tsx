          ...
          <div className="flex items-center gap-4">
            <Link href="/" className="flex items-center gap-2 group">
              <img
                ...
                alt="StudioX Icon"
                draggable="false"
                className="h-10 object-contain brightness-0 invert opacity-80 group-hover:opacity-100 transition-all select-none"
              />
              <img
                src="/studio_brandname.svg"
                alt="StudioX"
                draggable="false"
                className="h-6 object-contain brightness-0 invert opacity-80 group-hover:opacity-100 transition-all select-none hidden sm:block"
              />
            </Link>
